...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        ...
        <i class="fa fa-code" aria-hidden="true"></i> Laboratorium Teknik Informatika</a>
                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <ol class="breadcrumb mb-4">
                            ...
                            <li class="breadcrumb-item active">pemasukkan barang</li>
                        </ol>
                        </div>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <br>
        <input type="number" name="qty" class="from-control" placeholder="jumlah" required><br>
        <br>
        <input type="text" name="penerima"  class="from-control" placeholder="atas nama" require><br>
        <br>
